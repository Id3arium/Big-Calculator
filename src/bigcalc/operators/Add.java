...
/**
 * Executes the add command on two {@link BigInt}s.
 */
public class Add implements Operator {
	 ...
	 * {@inheritDoc}
	 * <p>
	 * This class does not use the token parameter. Two operands will always be popped off the operands stack, added and
	 * the result pushed back onto the stack.
	 * </p>
	 *
	 */
	@Override
	public void execute(Stack<String> operands, String token) {
		...
		operands.push(num1.plus(num2).toString());
	}
}
